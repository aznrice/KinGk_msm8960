/*
 * wcd9310.h  --  wcd9310 Soc Audio driver
 *
...
#if defined(CONFIG_MACH_MSM) || defined (CONFIG_SAMSUNG_GALAXYS)	       \
...
unsigned int voodoo_hook_wcd9310_write(struct snd_soc_codec *codec,
				      unsigned int reg, unsigned int value);
void voodoo_hook_fmradio_headset(void);
void voodoo_hook_wcd9310_pcm_probe(struct snd_soc_codec *codec);
void voodoo_hook_wcd9310_pcm_remove(void);
